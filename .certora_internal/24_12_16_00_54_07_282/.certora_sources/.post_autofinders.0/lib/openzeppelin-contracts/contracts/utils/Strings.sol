...
library Strings {
     ...
     */
    function toStringSigned(int256 value) internal pure returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00340000, 1037618708532) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00340001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00340005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00346000, value) }
     ...
     */
    function toHexString(uint256 value, uint256 length) internal pure returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00370000, 1037618708535) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00370001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00370005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00376001, length) }
     ...
     * representation.
     */
    function toHexString(address addr) internal pure returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00350000, 1037618708533) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00350001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00350005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00356000, addr) }
     ...
     */
    function toChecksumHexString(address addr) internal pure returns (string memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00380000, 1037618708536) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00380001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00380005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00386000, addr) }
